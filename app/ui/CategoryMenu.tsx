...
const categories = [
  ...
  },
  {
    ...
    subcategories: [
      { name: "Thương hiệu", items: ["ACER/PREDATOR", "ASUS/ROG", "MSI", "LENOVO", "DELL", "GIGABYTE/AORUS", "HP"] },
      { name: "Giá bán", items: ["Dưới 20 triệu", "Từ 20 đến 25 triệu", "Từ 25 đến 30 triệu", "Trên 30 triệu", "Gaming RTX 50 Series"] },
      { name: "ACER | PREDATOR", items: ["Nitro Series", "Aspire Series", "Predator Series", "ACER RTX 50 Series"] },
      { name: "ASUS | ROG Gaming", items: ["ROG Series", "TUF Series", "Zephyrus Series", "ASUS RTX 50 Series"] },
      { name: "MSI Gaming", items: ["Titan GT Series", "Stealth GS Series", "Raider Series", "Vector GP Series", "Crosshair / Pulse GL Series", "Sword / Katana GF66 Series", "Cyborg / Thin GF Series", "MSI RTX 50 Series"] },
      { name: "LENOVO Gaming", items: ["Legion Gaming", "LOQ Series", "RTX 50 Series"] },
      { name: "Dell Gaming", items: ["Dell Gaming G Series", "Alienware Series"] },
      { name: "HP Gaming", items: ["HP Victus", "HP Omen"] },
      { name: "Cấu hình", items: ["RTX 50 Series", "CPU Core Ultra", "CPU AMD"] },
      { name: "Linh - Phụ kiện Laptop", items: ["Ram laptop", "SSD laptop", "Ổ cứng di động"] },
    ],
  },
  {
    name: "PC GVN",
  ...
  },
  {
    ...
    icon: <PcCase className="h-4 w-4" />,
    subcategories: [
      { name: "Case - Theo hãng", items: ["Case ASUS", "Case Corsair", "Case Lianli", "Case NZXT", "Case Inwin", "Case Thermaltake"] },
      { name: "Case - Theo giá", items: ["Dưới 1 triệu", "Từ 1 triệu đến 2 triệu", "Trên 2 triệu"] },
      { name: "Nguồn - Theo hãng", items: ["Nguồn ASUS", "Nguồn DeepCool", "Nguồn NZXT", "Nguồn MSI"] },
      { name: "Nguồn - Theo công suất", items: ["Từ 400w - 500w", "Từ 500w - 600w", "Từ 700w - 800w", "Trên 1000w"] },
      { name: "Phụ kiện PC", items: ["Dây LED", "Dây rise - Dựng VGA", "Giá đỡ VGA", "Keo tản nhiệt"] },
      { name: "Loại tản nhiệt", items: ["Tản nhiệt AIO 240mm", "Tản nhiệt AIO 280mm", "Tản nhiệt AIO 360mm", "Tản nhiệt AIO 420mm", "Tản nhiệt khí", "Fan RGB"] },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { name: "Hãng RAM", items: ["Corsair", "Kingston", "G.Skill", "PNY"] },
      { name: "Dung lượng HDD", items: ["HDD 1TB", "HDD 2TB", "HDD 4TB - 6TB", "HDD trên 8TB"] },
      { name: "Hãng HDD", items: ["Wester Digital", "Seagate", "Toshiba"] },
      { name: "Dung lượng SSD", items: ["120GB - 128GB", "250GB - 256GB", "480GB - 512GB", "960GB - 1TB", "2TB", "Trên 2TB"] },
      { name: "Hãng SSD", items: ["Samsung", "Wester Digital", "Kingston", "Corsair", "PNY"] },
  ...
  },
  {
    ...
    subcategories: [
      { name: "Hãng sản xuất", items: ["LG", "Asus", "Samsung", "Dell", "Gigabyte", "MSI", "Acer", "Lenovo"] },
      { name: "Giá tiền", items: ["Dưới 5 triệu", "Từ 5 triệu đến 10 triệu", "Từ 10 triệu đến 20 triệu", "Từ 20 triệu đến 30 triệu", "Trên 30 triệu"] },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { name: "Giá tiền", items: ["Dưới 5 triệu", "Từ 5 triệu - 10 triệu", "Trên 10 triệu"] },
    ],
  },
  {
    name: "Phần mềm mạng",
    ...
    subcategories: [
      { name: "Hãng sản xuất", items: ["Asus", "LinkSys", "TP-LINK", "Mercusys"] },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { name: "Sony Playstation", items: ["Sony PS5 chính hãng", "Tay cầm chính hãng"] },
    ],
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      ...
      { name: "Chính sách", items: ["Chính sách & bảng giá thu VGA qua sử dụng", "Chính sách bảo hành", "Chính sách giao hàng", "Chính sách đổi trả"] },
    ],
  },
]
    ...
    <div className="w-64 mb-2 bg-white rounded-md border shadow-sm relative">
        <ul className="space-y-0">
          {categories.map((category) => (
            ...
            >
              <button className="w-full flex items-center justify-between px-4 py-1 text-sm hover:bg-slate-100 focus:bg-slate-100 focus:outline-none">
